...
class FloatingWindow extends PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    let { floatingWindowState: newValue, gridMargin } = nextProps;
    if (prevState) {
      let { floatingWindowState: oldValue, horizontal, vertical} = prevState;
      if (
        newValue === oldValue &&
  ...
  render() {
    let { floatingWindowState, horizontal, vertical } = this.state;
    return (
