...
import { consts as Widget, Icon, Theme } from '@lugia/lugia-web';
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <MapBox>
          <Map
            amapkey={'40220e361a7739dbb21228d67da8d1fb'}
            center={{ longitude: 116.516007, latitude: 39.937022 }}
            zoom={15}
          >
        ...
        <Text align={'center'}>
          {' '}
          <Icon iconClass={'lugia-icon-financial_environment'} /> 北京市朝阳区青年路达美中心T2 16层
        </Text>
      </Container>
    );
  }
